...
The **testthat suite is shipped** (v1.5.0): 36 tests / 62 assertions across three test files, enforced by the `testthat` job in GitHub Actions CI on every push and PR.
